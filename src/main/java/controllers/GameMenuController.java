...
public class GameMenuController {
    ...
    public GameMenuController() {
        ...
        try {
            ...
            FirebaseService.addListener("countries", "Alaska");
        } catch (Exception e) {
    ...
    public void canvasClicked(MouseEvent e) {
        System.out.println("Clicked in the canvas at x: " + e.getX() + " and y: " + e.getY() + "and Z: " + e.getZ());
        Country clickedCountry = getCountry(e.getX(), e.getY() ,e.getZ());
        if (clickedCountry != null) {
            clickedCountry.setCountryZ(150); //Hayyan: if on country clicked, the country raises.
            drawCountry(clickedCountry);
            System.out.println("Clicked country " + clickedCountry.getCountryName());
        }
    }

    public Country getCountry(double clickX, double clickY, double z){
    ...
    public void createCountries() {
        countries.add(new Country("Alaska", 60, 30, 0, 80, 60));
        countries.add(new Country("Alberta", 140, 80, 0, 80, 50));
        countries.add(new Country("Central America", 170, 210, 0, 65, 60));
        countries.add(new Country("Eastern United States", 230, 130, 0, 50, 80));
        countries.add(new Country("Greenland", 310, 20, 0, 80, 60));
        countries.add(new Country("Northwest Territory", 140, 30, 0, 120, 50));
        countries.add(new Country("Ontario", 220, 80, 0, 60, 50));
        countries.add(new Country("Quebec", 280, 90, 0, 50, 70));
        countries.add(new Country("Western United States", 140, 130, 0, 90, 80));
        countries.add(new Country("Venezuela", 230, 270, 0, 70, 50));
        countries.add(new Country("Brazil", 260, 320, 0, 90, 120));
        countries.add(new Country("Peru", 220, 320, 0, 40, 120));
        countries.add(new Country("Argentina", 230, 440, 0, 70, 100));
        countries.add(new Country("Great Britain", 430, 110, 0, 20, 40));
        countries.add(new Country("Iceland", 400, 90, 0, 20, 20));
        countries.add(new Country("Northern Europe", 470, 140, 0, 60, 40));
        countries.add(new Country("Scandinavia", 480, 20, 0, 50, 100));
        countries.add(new Country("Ukraine", 530, 70, 0, 100, 110));
        countries.add(new Country("Southern Europe", 470, 180, 0, 80, 40));
        countries.add(new Country("Western Europe", 410, 160, 0, 60, 40));
        countries.add(new Country("Madagascar", 570, 400, 0, 20, 40));
        countries.add(new Country("Egypt", 480, 240, 0, 70, 40));
        countries.add(new Country("North Africa", 390, 240, 0, 90, 90));
        countries.add(new Country("East Africa", 480, 280, 0, 80, 110));
        countries.add(new Country("Congo", 420, 330, 0, 60, 60));
        countries.add(new Country("South Africa", 450, 390, 0, 80, 110));
        countries.add(new Country("Syria", 550, 180, 0, 110, 70));
        countries.add(new Country("Afghanistan", 630, 110, 0, 70, 70));
        countries.add(new Country("Ural", 630, 55, 0, 80, 55));
        countries.add(new Country("India", 660, 180, 0, 60, 100));
        countries.add(new Country("China", 700, 110, 0, 90, 70));
        countries.add(new Country("Siberia", 710, 35, 0, 30, 75));
        countries.add(new Country("Siam", 720, 180, 0, 40, 70));
        countries.add(new Country("Mongolia", 740, 80, 0, 60, 30));
        countries.add(new Country("Irkutsk", 740, 55, 0, 60, 25));
        countries.add(new Country("Yakutsk", 740, 30, 0, 60, 25));
        countries.add(new Country("Kamchatka", 800, 30, 0, 30, 70));
        countries.add(new Country("Japan", 840, 80, 0, 20, 40));
        countries.add(new Country("Indonesia", 760, 300, 0, 30, 30));
        countries.add(new Country("Western Australia", 770, 360, 0, 60, 70));
        countries.add(new Country("Eastern Australia", 830, 360, 0, 50, 70));
        countries.add(new Country("New Guinea", 830, 310, 0, 40, 25));
    ...
    public void moveTroops(Country country, User user) {
